export type CashEarnsSectionProps = {
  variant: string;
...
export const CashEarnsSection = (props: CashEarnsSectionProps) => {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <div
          className={
            props.variant === "variant1"
              ? "box-border caret-transparent w-full min-h-[auto] min-w-[auto] md:min-h-0 md:min-w-0"
              : "box-border caret-transparent min-h-0 min-w-0 w-full md:min-h-[auto] md:min-w-[auto]"
          }
        >
          <div className="relative box-border caret-transparent max-w-screen-xl z-[9] mx-auto px-4 py-8 md:px-20">
            <div
              className={
                props.variant === "variant1"
                  ? "items-start box-border caret-transparent flex flex-col gap-y-3 mb-10"
                  : "box-border caret-transparent flex text-left w-full"
              }
            >
              {props.variant === "variant2" && (
                <div className="box-border caret-transparent flex flex-col justify-around min-h-0 min-w-0 w-full md:min-h-[auto] md:min-w-[auto] md:w-6/12">
                  <div className="relative items-start box-border caret-transparent flex flex-col max-w-none min-h-0 min-w-0 md:max-w-[752px] md:min-h-[auto] md:min-w-[auto]">
                    <div className="items-start box-border caret-transparent gap-x-4 flex flex-col min-h-0 min-w-0 gap-y-4 mb-10 md:min-h-[auto] md:min-w-[auto]">
                      <h2
                        className={
                          props.variant === "variant1"
                            ? "text-[32px] font-medium box-border caret-transparent leading-[51.2px] min-h-[auto] min-w-[auto] uppercase mb-2 font-tusker_grotesk_6500 md:text-5xl md:leading-[76.8px] md:min-h-0 md:min-w-0"
                            : "text-[32px] font-medium box-border caret-transparent leading-[51.2px] min-h-0 min-w-0 uppercase mb-2 font-tusker_grotesk_6500 md:text-5xl md:leading-[76.8px] md:min-h-[auto] md:min-w-[auto]"
                        }
                      >
                      ...
                      <div
                        className={
                          props.variant === "variant1"
                            ? "text-base font-medium box-border caret-transparent leading-6 min-h-[auto] min-w-[auto] md:text-xl md:leading-[30px] md:min-h-0 md:min-w-0"
                            : "text-base font-medium box-border caret-transparent leading-6 min-h-0 min-w-0 md:text-xl md:leading-[30px] md:min-h-[auto] md:min-w-[auto]"
                        }
                      >
                        <div className="text-base box-border caret-transparent leading-6 md:text-xl md:leading-[30px]">
                          <ul className="text-base box-border caret-transparent leading-6 mb-4 pl-8 md:text-xl md:leading-[30px]">
                            {props.bulletPoints.map((point, index) => (
                              <li
                                key={index}
                                className="text-base box-border caret-transparent leading-6 md:text-xl md:leading-[30px]"
                              >
                                {point}
                              </li>
                            ))}
                    ...
                    <div
                      className={
                        props.variant === "variant1"
                          ? "items-center box-border caret-transparent gap-x-6 flex flex-col gap-y-6 md:flex-row md:gap-y-[normal]"
                          : "items-center box-border caret-transparent gap-x-6 flex flex-col min-h-0 min-w-0 gap-y-6 md:flex-row md:min-h-[auto] md:min-w-[auto] md:gap-y-[normal]"
                      }
                    >
                      <a
                        href={props.ctaUrl}
                        className={
                          props.variant === "variant1"
                            ? "font-semibold items-center self-center bg-red-600 box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] text-center uppercase text-nowrap border border-red-600 px-6 py-3 rounded-[80px] border-solid md:self-auto md:min-h-0 md:min-w-0 hover:bg-red-800 hover:border-red-800"
                            : "font-semibold items-center self-center bg-red-600 box-border caret-transparent flex justify-center min-h-0 min-w-0 text-center uppercase text-nowrap border border-red-600 px-6 py-3 rounded-[80px] border-solid md:self-auto md:min-h-[auto] md:min-w-[auto] hover:bg-red-800 hover:border-red-800"
                        }
                      >
                        {props.ctaText}
                      </a>
                  ...
                  <div
                    className={
                      props.variant === "variant1"
                        ? "text-xs font-medium box-border caret-transparent leading-[18px] mt-14"
                        : "text-xs font-medium box-border caret-transparent leading-[18px] min-h-0 min-w-0 mt-14 md:min-h-[auto] md:min-w-[auto]"
                    }
                  >
                    <div className="box-border caret-transparent">
                      <p className="box-border caret-transparent mb-4">
                        <a className="box-border caret-transparent underline hover:text-red-600 hover:border-red-600">
                          {props.termsText}
                        </a>
                      </p>
                    </div>
            ...
            {props.variant === "variant2" && (
              <div className="box-border caret-transparent flex flex-col justify-around min-h-0 min-w-0 w-full md:min-h-[auto] md:min-w-[auto] md:w-6/12">
                <img
                  src={props.secondaryImageUrl}
                  alt={props.secondaryImageAlt}
                  className="self-center box-border caret-transparent justify-self-center min-h-0 min-w-0 w-full mt-12 md:min-h-[auto] md:min-w-[auto] md:w-3/5 md:mt-0"
                />
              </div>
            )}
          </div>
